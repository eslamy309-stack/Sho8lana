...
/* ── Mouse-following spotlight (ibelick) ── */
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        'bg-[radial-gradient(circle_at_center,theme(colors.brand.400/20%),transparent_70%)]',
...
/* ── Static SVG spotlight (Aceternity) ── */
type SvgSpotlightProps = { className?: string; fill?: string }

export function SvgSpotlight({ className, fill }: SvgSpotlightProps) {
  return (
    <svg
      className={cn(
