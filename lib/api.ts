...
function wuzzufUrl(title: string) {
  return `https://wuzzuf.net/search/jobs/?q=${encodeURIComponent(title)}&l=Cairo%2C+Egypt`
}

export function getWuzzufMockJobs(): LiveJob[] {
  return [
    { id: 'w1',  title: 'Accountant — Fresh Graduate',    company: 'Al-Mansour Automotive', location: 'Giza, Egypt',          postedAt: ago(1),  url: wuzzufUrl('Accountant Fresh Graduate'),    source: 'wuzzuf', type: 'FULLTIME' },
    { id: 'w2',  title: 'Digital Marketing Specialist',   company: 'Cleopatra Hospitals',   location: 'Heliopolis, Egypt',    postedAt: ago(2),  url: wuzzufUrl('Digital Marketing Specialist'),  source: 'wuzzuf', type: 'FULLTIME', salary: 'EGP 8,000/mo' },
    { id: 'w3',  title: 'HR Coordinator',                 company: 'El-Araby Group',        location: 'Cairo, Egypt',         postedAt: ago(1),  url: wuzzufUrl('HR Coordinator'),                source: 'wuzzuf', type: 'FULLTIME', salary: 'EGP 7,000/mo' },
    { id: 'w4',  title: 'Sales Engineer — Fresh Grad',    company: 'Schneider Electric EG', location: 'Smart Village, Egypt', postedAt: ago(3),  url: wuzzufUrl('Sales Engineer Fresh Graduate'), source: 'wuzzuf', type: 'FULLTIME', salary: 'EGP 10,000/mo' },
    { id: 'w5',  title: 'Customer Success Rep',           company: 'Jumia Egypt',           location: 'Maadi, Egypt',         postedAt: ago(5),  url: wuzzufUrl('Customer Success Representative'), source: 'wuzzuf', type: 'FULLTIME', salary: 'EGP 6,000/mo' },
    { id: 'w6',  title: 'Logistics Coordinator — Intern', company: 'DHL Egypt',             location: '6th October, Egypt',   postedAt: ago(2),  url: wuzzufUrl('Logistics Coordinator Intern'),  source: 'wuzzuf', type: 'INTERN',   salary: 'EGP 3,500/mo' },
    { id: 'w7',  title: 'UI/UX Design Intern',            company: 'Instabug',              location: 'Nasr City, Egypt',     postedAt: ago(1),  url: wuzzufUrl('UI UX Design Intern'),           source: 'wuzzuf', type: 'INTERN',   salary: 'EGP 4,000/mo' },
    { id: 'w8',  title: 'Financial Planning Analyst',     company: 'Hassan Allam Group',    location: 'New Cairo, Egypt',     postedAt: ago(4),  url: wuzzufUrl('Financial Planning Analyst'),    source: 'wuzzuf', type: 'FULLTIME', salary: 'EGP 11,000/mo' },
    { id: 'w9',  title: 'Content Creator — Arabic',       company: 'Noon.com Egypt',        location: 'New Cairo, Egypt',     postedAt: ago(1),  url: wuzzufUrl('Content Creator Arabic'),        source: 'wuzzuf', type: 'FULLTIME', salary: 'EGP 7,500/mo' },
    { id: 'w10', title: 'Business Development Rep',        company: 'Khazna Data Centers',  location: 'New Capital, Egypt',   postedAt: ago(3),  url: wuzzufUrl('Business Development Representative'), source: 'wuzzuf', type: 'FULLTIME', salary: 'EGP 9,000/mo' },
  ]
}

function linkedinUrl(title: string) {
  return `https://www.linkedin.com/jobs/search/?keywords=${encodeURIComponent(title)}&location=Egypt`
}
